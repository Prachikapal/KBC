$(document).ready(function () {
  ...
  let aArray = [
    ...
    "Africa",
    "November 14, 2011",
    "Observe perfect Chastity, Adopt Poverty, Follow truth and Cultivated Fearlessness.",
    "Earthquakes",
  ];
  ...
  let bArray = [
    ...
    "Australia",
    "March 5, 2009",
    "Observe perfect Chastity, Gain Money, Follow truth and Cultivated Fearlessness.",
    "Rainfall",
  ];
  ...
  let cArray = [
    ...
    "Germany",
    "Bicc Brothers",
    "The formatio of rocks",
    "Europe",
    "March 10, 2008",
    "Observe perfect Chastity, Adopt Poverty, Follow truth and Cultivated Power.",
    "Ocean depth",
  ];
  ...
  let dArray = [
    ...
    "Asia",
    "October 2, 2007",
    "Observe perfect Chastity, Gain Money, Follow truth and Cultivated Power.",
    "Sound intensity",
  ];
  ...
  let correctArray = [
    ...
    "Africa",
    "October 2, 2007",
    "Observe perect Chastity, Adopt Poverty, Follow truth and Cultivated Fearlessness.",
    "Sound intensity",
  ];
  ...
  function end() {
    ...
    clearInterval(clock);
    setTimeout(() => {
      alert(`Your Score is : ${$("#span").text()} out 0f 50`);
    }, 1000);
  }
});
