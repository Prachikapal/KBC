$(document).ready(() => {
  ...
  opt1 = $(
    `<input type = "radio" name = "first" id = "one" class = "option">&nbsp<label for = "one" id = "opt1"></label><br>`
  );
  $(opt1).appendTo("#sopt");
  opt2 = $(
    `<input type = "radio" name = "first" id = "two" class = "option">&nbsp<label for = "two" id = "opt2"></label><br>`
  );
  $(opt2).appendTo("#sopt");
  opt3 = $(
    `<input type = "radio" name = "first" id = "three" class = "option">&nbsp<label for = "three" id = "opt3"></label><br>`
  );
  $(opt3).appendTo("#sopt");
  opt4 = $(
    `<input type = "radio" name = "first" id = "four" class = "option">&nbsp<label for = "four" id = "opt4"></label><br>`
  );
  $(opt4).appendTo("#sopt");
