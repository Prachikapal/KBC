...
let quesArray = ["What is the full name of Shinchan ?",
...
let aArray = ["Shinnosuke Ogawa","Beans","Gilli Danda Competition","monkey,donkey and mouse","Rat","Iga valley",
            "Motu patlu don't care about the childen","Olivia","Sunio","Chang"];

let bArray = ["Shin Chan Nohara","Capsicum","Office Cleaning","depia,dytu and fyuio","Frog","coga valley",
            "Patlu can not do it","Monica","Shizuka","Kaifu"];

let cArray = ["Suzuki Nohara","Carrot","Flying Helmet","sanal,bandal and fandal","Snake","Japan",
            "Motu patlu did something to get train","Sweety","Doraemon","King Indravarma"];

let dArray = ["Shinnosuke Nohara","Garlic","John Bnega Don","suparna,tarak and de.j","Blue Whale","Hiroshima",
            "John kidnapped the childen","Pinky","Nobita","Ming"];

let correctArray = ["Shinnosuke Nohara","Capsicum","John Bnega Don","suparna,tarak and de.j","Snake","Iga valley",
                    "Motu patlu did something to get train","Monica","Sunio","Kaifu"];
