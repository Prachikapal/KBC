$(document).ready(function(){
    let quesArray = ["Which movie has become the first Bollywood film to go plastic-free?",
    ...
    let aArray = ["War","Nana Patekar","Bhanu Athaiya","Reporter","Rajesh Khanna","Amit Mishra","Kassav","S.S Rajamouli","Golmaal 5","Akshay Kumar"];
    
    let bArray = ["Dream Girl","Nawazuddin Siddiqui","AR Rahman","Photographers","Dharmendra","Arijit Singh","Sairat","Sanjay Leele Bhansali","Toofan","Ranbir Kapoor"];
    
    let cArray = ["Mission Mangal","Sonu Sood","Rasul Pookutty","Professors","Rajender","Mohit Chauhan","Dhurala","Anurag Kashyap","Radhe","Ranveer Singh"];
    
    let dArray = ["Coolie No. 1","Amitabh Bachchan","None of the above","Lawyers","Puneet Issar","kk","Hirkani","S.Shankar","Brahmastra","Shahid Kapoor"];
    
    let correctArray = ["Coolie No. 1","Sonu Sood","Bhanu Athaiya","Photographers","Puneet Issar","Amit Mishra","Sairat","S.S Rajamouli","Brahmastra","Ranveer Singh"];
