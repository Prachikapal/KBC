$(document).ready( function(){
    let quesArray = ["Who is the first Indian woman to win an Asian Games gold in 400m run ?",
    ...
    let aArray = ["M.L.Valsamma","Arun Jaitley Stadium","Saurashtra","Syed Mushtaq Ali Trophy","Neymar",
                "Pankaj Advani: Billiards","Sakshi Malik","Virat Kohli","1930","Sprinter"
    ];

    let bArray = ["P.T. Usha","Sheila Dikshit Stadium"," Mumbai","Deodhar Trophy"," L. Messi",
                " Anjali Bhagwat: Shooting","Bajrang Punia"," Rohit Sharma","1934","Boxing"
    ];

    let cArray = ["Kamaljit Sandhu","Gautam Gambhir Stadium","Vidarbha","Duleep Trophy","C. Ronaldo",
                "Muhammed Anas Yahiya: Boxing","Mirabai Chanu","Jasprit Bumrah","1938","Wrestling"
    ];

    let dArray = ["K.Malleshwari","Ajit Wadekar Stadium","Rajasthan","Santosh Trophy","Luka Mordic",
                "Deepa Malik: Athletics","None of the above","Shikhar Dhawan","1948","Javelin throw"
    ];

    let correctArray = ["Kamaljit Sandhu","Arun Jaitley Stadium","Vidarbha","Santosh Trophy"," L. Messi",
                "Muhammed Anas Yahiya: Boxing","Bajrang Punia","Shikhar Dhawan","1930","Boxing"
    ];
