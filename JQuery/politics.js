$(document).ready(function(){
    let quesArray = ["The members of the Rajya Sabha are elected by",
    ...
    let aArray = ["the people","Parliament","14th Lok Sabha","25 years","Consolidated Fund of India","advice of the chief justice of India","Sardar Patel","determined by the state legislative assembly of a state","Mahatma Gandhi","Atal Bihari Vajpayee"];
    
    let bArray = ["Lok Sabha","High courts","15th Lok Sabha","21 years","Consolidated Fund of the state where he last served","advice of the prime minister","Jawaharlal Nehru","of four years","Jawaharlal Nehru","Morarji Desai"];
    
    let cArray = ["elected members of the legislative assembly","Supreme Court","16th Lok Sabha","18 years","Consolidated Funds of the different states where he has served","recommendation of Lok Sabha","K.M. Munshi","of six years","I.K. Gujral","Charan Singh"];
    
    let dArray = ["elected members of the legislative council","Election Commission","17th Lok Sabha","35 years","Contingency Fund of India","recommendation of the Rajya Sabha","B.R. Ambedkar","None of the above","Dr. B.R. Ambedkar","Lal Bahudar Shastri"];
    
    let correctArray = ["elected members of the legislative assembly","High courts","17th Lok Sabha","25 years","Consolidated Fund of India","advice of the prime minister","Jawaharlal Nehru","of six years","Dr. B.R. Ambedkar","Morarji Desai"];
